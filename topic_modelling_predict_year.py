...
def run_TM(n_topics, doprint, doreturn):
    ...
    if doprint:
        ...
        for year in years_mean_probs:
            ...
            year_probs_for_R.write(year+';'+probs[0]+';Topic0\n')
            year_probs_for_R.write(year+';'+probs[1]+';Topic1\n')
            year_probs_for_R.write(year+';'+probs[2]+';Topic2\n')
            year_probs_for_R.write(year+';'+probs[3]+';Topic3\n')
            year_probs_for_R.write(year+';'+probs[4]+';Topic4\n')
