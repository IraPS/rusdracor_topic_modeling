...
infolder = '/Users/IrinaPavlova/Desktop/Uni/Бакалавриат/2015-2016/Programming/github desktop/dracor-rusdracor/tei' ## папка с TEI/XML #'testtei'
...
def parse_xml(path, filename):
    ...
    for sp in root.iterfind('.//tei:sp', ns):
        ...
        if notmult:
            ...
            textbyplay = codecs.open(results+'/all_in_one_doc/all_plays_texts.txt','a','utf-8')
            #textbycharacter = codecs.open(results + '/bycharacter/'+speechcode+'.txt','a','utf-8')
            #textbygender = codecs.open(results + '/bysex/'+speakersex+'.txt','a','utf-8')
